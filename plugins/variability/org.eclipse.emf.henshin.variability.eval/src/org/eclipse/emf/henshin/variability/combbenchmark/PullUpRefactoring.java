		...
		for (EStructuralFeature feat1 : class1.getEStructuralFeatures()) {
			if (feat1 instanceof EAttribute) {
				...
				if (feat2 != null && feat2 instanceof EAttribute
					...
					// The following line ensures that 'attribute' is also
					// removed from class1's eStructuralFeatures (due to
					// containment property)
					superType.getEStructuralFeatures().add(attribute);
					class2.getEStructuralFeatures().remove(feat2);
				}
			}
		}
	}
