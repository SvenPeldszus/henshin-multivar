...
public class AddElementToConfigurationAction extends AbstractModifyPresenceConditionAction {
	...
	protected String getPresenceCondition(ModelElement modelElement) {
		...
		String configurationPC = VariabilityModelHelper.getPresenceCondition(configuration);
		String result = VariabilityTransactionHelper.INSTANCE.getPresenceCondition(modelElement);
