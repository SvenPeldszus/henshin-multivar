...
public class VBExecution {
	...
	public void transformSecPlModel(IFeatureModel fmP, List<EObject> roots, Rule vbRule) throws TimeoutException, InconsistentRuleException {
	...
	public void transformSecPlModelWithVBRule(IFeatureModel fmP, List<EObject> roots, Rule vbRule,
			RuleToProductLineEngine engine) throws TimeoutException, InconsistentRuleException {
	...
	public void transformSecPlModelWithVBRule(IFeatureModel fmP, List<EObject> roots, Rule vbRule,
			RuleToProductLineEngine engine, Map<EObject, String> pcsP, EGraphImpl graphP) throws InconsistentRuleException {
