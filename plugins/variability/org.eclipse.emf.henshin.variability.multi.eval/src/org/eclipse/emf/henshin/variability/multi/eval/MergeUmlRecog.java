...
//import org.eclipse.emf.henshin.variability.mergein.test.util.Diagnostic;
...
//	private static final String FILE_PATH_RULES_RESULT = "vbrules/";
...
//
//	private double clusterThreshold = 0.51;
//	private int minSubCloneSize = 5;
//	private boolean includeRhs = false;
//
...
//		deleteFolder(new File(FILE_PATH + FILE_PATH_RULES_RESULT));
//
...
//		module = LoadingHelper.loadAllRulesAsOneModule(rs, FILE_PATH, FILE_PATH_RULES, 2, RuleSet.ALL);
...
//		if (MERGE) {
//			try {
//				Set<Rule> notmerged = new HashSet<Rule>(module.getAllRules());
//				for (MergeRule mergeRule : result.getMergeClusters()) {
//
//					NewMerger merger = new NewMerger(mergeRule);
//					merger.merge();
//					Rule masterRule = mergeRule.getMasterRule();
//					Diagnostic.findDanglingObject(mergeRule.getMasterRule());
//
//					Module newModule = HenshinFactoryImpl.eINSTANCE.createModule();
...
//	}
//
//	private void prefilterCloneDetectionResult(CloneGroupDetectionResult cloneGroupDetectionResult) {
...
//	}
//
//	private void initialize(HenshinResourceSet rs) {
